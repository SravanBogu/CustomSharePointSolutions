...
using Core.Domain;
using Core.Data;
using Integration.Social.Twitter.Domain;
using System.Threading;
using System.Collections.Generic;

namespace Integration.Social.Twitter
{
    public class Helper
    {
        ...
        public async Task GetSearchTweetsAsync(string twitterAccountToDisplay, ulong sinceID)
        {
            try
            {
                ...
                //string twitterAccountToDisplay = "thenorthface"; //Linq2Twitr
                int count = 5;
                int maxStatuses = 30;
                int lastStatusCount = 0;
                //last tweet processed on previous query set
                //ulong sinceID = 564516902412623872;
                ulong maxID;
